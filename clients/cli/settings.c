                        ...
                        NmcPropertyGetType type)
{
	...
	set_val_str (arr, 18, nmc_property_802_1X_get_phase2_auth (setting, type));
	set_val_str (arr, 19, nmc_property_802_1X_get_phase2_autheap (setting, type));
	set_val_str (arr, 20, nmc_property_802_1X_get_phase2_ca_cert (setting, type));
	set_val_str (arr, 21, GET_SECRET (secrets, setting, nmc_property_802_1X_get_phase2_ca_cert_password, type));
	set_val_str (arr, 22, nmc_property_802_1X_get_phase2_ca_cert_password_flags (setting, type));
	set_val_str (arr, 23, nmc_property_802_1X_get_phase2_ca_path (setting, type));
	set_val_str (arr, 24, nmc_property_802_1X_get_phase2_subject_match (setting, type));
	set_val_str (arr, 25, nmc_property_802_1X_get_phase2_altsubject_matches (setting, type));
	set_val_str (arr, 26, nmc_property_802_1X_get_phase2_domain_suffix_match (setting, type));
	set_val_str (arr, 27, nmc_property_802_1X_get_phase2_client_cert (setting, type, secrets));
	set_val_str (arr, 28, GET_SECRET (secrets, setting, nmc_property_802_1X_get_phase2_client_cert_password, type));
	set_val_str (arr, 29, nmc_property_802_1X_get_phase2_client_cert_password_flags (setting, type));
	set_val_str (arr, 30, GET_SECRET (secrets, setting, nmc_property_802_1X_get_password, type));
	set_val_str (arr, 31, nmc_property_802_1X_get_password_flags (setting, type));
	set_val_str (arr, 32, GET_SECRET (secrets, setting, nmc_property_802_1X_get_password_raw, type));
	set_val_str (arr, 33, nmc_property_802_1X_get_password_raw_flags (setting, type));
	set_val_str (arr, 34, nmc_property_802_1X_get_private_key (setting, type, secrets));
	set_val_str (arr, 35, GET_SECRET (secrets, setting, nmc_property_802_1X_get_private_key_password, type));
	set_val_str (arr, 36, nmc_property_802_1X_get_private_key_password_flags (setting, type));
	set_val_str (arr, 37, nmc_property_802_1X_get_phase2_private_key (setting, type, secrets));
	set_val_str (arr, 38, GET_SECRET (secrets, setting, nmc_property_802_1X_get_phase2_private_key_password, type));
	set_val_str (arr, 39, nmc_property_802_1X_get_phase2_private_key_password_flags (setting, type));
	set_val_str (arr, 40, GET_SECRET (secrets, setting, nmc_property_802_1X_get_pin, type));
	set_val_str (arr, 41, nmc_property_802_1X_get_pin_flags (setting, type));
	set_val_str (arr, 42, nmc_property_802_1X_get_system_ca_certs (setting, type));
	g_ptr_array_add (nmc->output_data, arr);
