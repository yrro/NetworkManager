                        ...
                        NmcPropertyGetType type)
{
	...
	set_val_str (arr, 6, nmc_property_802_1X_get_ca_path (setting, type));
	set_val_str (arr, 7, nmc_property_802_1X_get_subject_match (setting, type));
	set_val_str (arr, 8, nmc_property_802_1X_get_altsubject_matches (setting, type));
	set_val_str (arr, 9, nmc_property_802_1X_get_domain_suffix_match (setting, type));
	set_val_str (arr, 10, nmc_property_802_1X_get_client_cert (setting, type, secrets));
	set_val_str (arr, 11, nmc_property_802_1X_get_phase1_peapver (setting, type));
	set_val_str (arr, 12, nmc_property_802_1X_get_phase1_peaplabel (setting, type));
	set_val_str (arr, 13, nmc_property_802_1X_get_phase1_fast_provisioning (setting, type));
	set_val_str (arr, 14, nmc_property_802_1X_get_phase2_auth (setting, type));
	set_val_str (arr, 15, nmc_property_802_1X_get_phase2_autheap (setting, type));
	set_val_str (arr, 16, nmc_property_802_1X_get_phase2_ca_cert (setting, type));
	set_val_str (arr, 17, nmc_property_802_1X_get_phase2_ca_path (setting, type));
	set_val_str (arr, 18, nmc_property_802_1X_get_phase2_subject_match (setting, type));
	set_val_str (arr, 19, nmc_property_802_1X_get_phase2_altsubject_matches (setting, type));
	set_val_str (arr, 20, nmc_property_802_1X_get_phase2_domain_suffix_match (setting, type));
	set_val_str (arr, 21, nmc_property_802_1X_get_phase2_client_cert (setting, type, secrets));
	set_val_str (arr, 22, GET_SECRET (secrets, setting, nmc_property_802_1X_get_password));
	set_val_str (arr, 23, nmc_property_802_1X_get_password_flags (setting, type));
	set_val_str (arr, 24, GET_SECRET (secrets, setting, nmc_property_802_1X_get_password_raw));
	set_val_str (arr, 25, nmc_property_802_1X_get_password_raw_flags (setting, type));
	set_val_str (arr, 26, nmc_property_802_1X_get_private_key (setting, type, secrets));
	set_val_str (arr, 27, GET_SECRET (secrets, setting, nmc_property_802_1X_get_private_key_password));
	set_val_str (arr, 28, nmc_property_802_1X_get_private_key_password_flags (setting, type));
	set_val_str (arr, 29, nmc_property_802_1X_get_phase2_private_key (setting, type, secrets));
	set_val_str (arr, 30, GET_SECRET (secrets, setting, nmc_property_802_1X_get_phase2_private_key_password));
	set_val_str (arr, 31, nmc_property_802_1X_get_phase2_private_key_password_flags (setting, type));
	set_val_str (arr, 32, GET_SECRET (secrets, setting, nmc_property_802_1X_get_pin));
	set_val_str (arr, 33, nmc_property_802_1X_get_pin_flags (setting, type));
	set_val_str (arr, 34, nmc_property_802_1X_get_system_ca_certs (setting, type));
	g_ptr_array_add (nmc->output_data, arr);
